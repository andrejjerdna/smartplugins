...
namespace SmartPlugins.Macros.Library
{
    ...
    /// Reverse part points
    /// </summary>
    public class PointsReverseMacro : ITeklaMacro
    {
        ...
        public PointsReverseMacro(ISmartModel smartModel,
        ...
        private void Macro()
        {
            ...
            _partOperations.ReverseLocationPointsModelObject(modelObject);
