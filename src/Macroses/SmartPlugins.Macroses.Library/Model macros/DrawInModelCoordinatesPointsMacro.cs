...
namespace SmartPlugins.Macroses.Library
{
    ...
    /// Reverse part points
    /// </summary>
    public class DrawInModelCoordinatesPointsMacro : ITeklaMacro
    {
        ...
        public DrawInModelCoordinatesPointsMacro(ISmartModel smartModel,
        ...
        private void Macro()
        {
            ...
            _partOperations.DrawInModelCoordinatesPointsModelObject(modelObject);
        }
    }
}
