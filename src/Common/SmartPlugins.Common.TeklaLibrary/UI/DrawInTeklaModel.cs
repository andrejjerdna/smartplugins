...
namespace SmartPlugins.Common.TeklaLibrary
{
    ...
    /// </summary>
    public class DrawInTeklaModel : IDrawInTeklaModel
    {
        /// <summary>
        /// Draw tekla object coordinate system
        /// </summary>
        /// <param name="objectCoordinateSystem">Object coordinate system</param>
        public void DrawTeklaObjectCoordinateSystem<T>(T coordinateSystem) where T : class
        {
            if (coordinateSystem is CoordinateSystem objectCoordinateSystem)
            {
